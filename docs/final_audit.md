...
1. Chosen thesis: Robotic Common-Sense Tests explores `Turn common-sense physical assumptions into executable affordance tests.` for physical reasoning for robots.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/96.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/96_robotic_common_sense_tests
