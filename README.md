...
This repository contains a hardened, honest workshop-only robotics paper draft for `robotic_common_sense_tests`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/96.pdf`
